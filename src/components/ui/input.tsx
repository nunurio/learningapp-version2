  ...
  ({ className, type = "text", ...props }, ref) => {
    return (
      <input
        ...
        data-slot="input"
        className={cn(
          "flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground shadow-xs transition-all duration-200 ease-in-out outline-none",
          ...
          "focus-visible:border-[hsl(var(--primary-400)_/_0.8)] focus-visible:bg-[hsl(var(--bg))] focus-visible:shadow-[0_0_0_3px_hsl(var(--primary-400)_/_0.1)] focus-visible:ring-2 focus-visible:ring-[hsl(var(--primary-400)_/_0.2)] focus-visible:ring-offset-0",
